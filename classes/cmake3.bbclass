...
list(APPEND CMAKE_MODULE_PATH "${STAGING_DATADIR}/cmake3/Modules/")
...
cmake3_do_configure() {
	if [ "${OECMAKE_BUILDPATH}" ]; then
		bbnote "cmake3.bbclass no longer uses OECMAKE_BUILDPATH.  The default behaviour is now out-of-tree builds with B=WORKDIR/build."
	fi
