...
PREFERRED_VERSION_libarchive="3.0.2"
...
EXTRA_OECMAKE=" \
    -DCMAKE_DOC_DIR=${docdir_stripped}/cmake3-${CMAKE_MAJOR_VERSION} \
...
do_install_append_class-nativesdk() {
    mkdir -p ${D}${datadir}/cmake3
    install -m 644 ${WORKDIR}/OEToolchainConfig.cmake ${D}${datadir}/cmake3/
...
FILES_${PN} += "${datadir}/cmake3-${CMAKE_MAJOR_VERSION}"
FILES_${PN}-doc += "${docdir}/cmake3-${CMAKE_MAJOR_VERSION}"
